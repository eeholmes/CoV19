...
Overall, it looks like the first wave will last well into summer for most of the US (excluding part of the NE), even if the curves were to start turning downward today. In terms of what kind of death rates to expect for the first wave in the US, in Europe and in the US Northeast, the high rates were about 1000 per million. In Europe, some countries controlled the wave down to under 500 per million or even under 100 per million. 
