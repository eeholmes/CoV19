...
The hot states right now are New Jersey, Massachusetts, Connecticut, Deleware, Maryland, Rhode Island, Illinois and District of Columbia (I know its not a state..) and all have daily new cases of 150 to 200 per million. The IHME model shows all regions out of ICU beds but ok on regular hospital beds except Connecticut: https://covid19.healthdata.org/united-states-of-america. But I haven't seen news reports to that effect so I am dubious if that is true.
